...
export const translations = {
    en: {
        ...
        hero: {
            ...
            description: "Hi, I'm Ajekkk. A creative developer bridging the gap between engineering and design. I build immersive digital experiences with clean code.",
    ...
    id: {
        ...
        hero: {
            ...
            description: "Halo, saya Ajekkk. Pengembang kreatif yang menjembatani teknik dan desain. Saya membangun pengalaman digital yang imersif dengan kode yang rapi.",
